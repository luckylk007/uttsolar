  ...
  return (
    <div className="flex flex-col bg-white text-[#17220F]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16 pb-20 sm:pt-20 sm:pb-28 lg:pt-24 lg:pb-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1F2E14] border border-[#46A304]/40 text-xs font-bold text-[#70C92F] uppercase tracking-wider">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-[54px] font-heading font-extrabold tracking-tight text-white leading-[1.18]">
                ...
                <span className="text-[#46A304]">बिजली बिल शून्य करें।</span>
              </h1>
              ...
              <div className="bg-[#1F2E14]/90 border border-white/10 rounded-2xl p-4 max-w-xl mx-auto lg:mx-0 shadow-lg">
                <div className="grid grid-cols-3 divide-x divide-white/10 text-center">
                  ...
                  <div className="px-2">
                    <span className="text-[11px] font-bold text-[#46A304] block">सुझाया गया प्लांट</span>
                    <span className="text-base sm:text-lg font-heading font-bold text-[#46A304]">3 kW सिस्टम</span>
                  </div>
                  <div className="px-2">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                <Link
                  ...
                  className="group inline-flex items-center gap-3 px-6 py-3.5 rounded-full text-sm font-extrabold text-[#17220F] bg-[#FFDE21] hover:bg-[#46A304] hover:text-white shadow-md hover:shadow-xl transition"
                >
            ...
            <div className="lg:col-span-5">
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl border border-[#E2E7DE] text-[#17220F]">
                <div className="flex items-center justify-between mb-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider text-[#46A304] bg-[#F7F9F5]">
                    <LeafIcon className="w-3.5 h-3.5" />
                    30 सेकंड में बुकिंग
                  </span>
                  <span className="text-xs text-[#66705F] font-semibold">100% मुफ्त सर्वे</span>
                </div>
                <h3 className="text-xl sm:text-2xl font-heading font-extrabold text-[#17220F] leading-tight">
                  मुफ्त रूफटॉप साइट सर्वे बुक करें
                </h3>
                <p className="text-xs text-[#66705F] mt-1 mb-4">
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section className="bg-white border-b border-[#E2E7DE] py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-8">
            <h2 className="text-xl sm:text-2xl font-heading font-bold text-[#17220F]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 pt-4">
            <div className="text-center p-3">
              <div className="text-3xl sm:text-4xl font-heading font-extrabold text-[#17220F]">10K+</div>
              <div className="text-xs font-bold text-[#46A304] uppercase tracking-wider mt-1">kW क्षमता</div>
              <div className="text-[11px] text-[#66705F]">स्थापित व चालू</div>
            </div>
            <div className="text-center p-3">
              <div className="text-3xl sm:text-4xl font-heading font-extrabold text-[#17220F]">15K+</div>
              <div className="text-xs font-bold text-[#46A304] uppercase tracking-wider mt-1">संतुष्ट परिवार</div>
              <div className="text-[11px] text-[#66705F]">शून्य मासिक बिजली बिल</div>
            </div>
            <div className="text-center p-3">
              <div className="text-3xl sm:text-4xl font-heading font-extrabold text-[#17220F]">340+</div>
              <div className="text-xs font-bold text-[#46A304] uppercase tracking-wider mt-1">व्यावसायिक प्रोजेक्ट</div>
              <div className="text-[11px] text-[#66705F]">होटल, स्कूल व फैक्ट्रीज</div>
            </div>
            <div className="text-center p-3">
              <div className="text-3xl sm:text-4xl font-heading font-extrabold text-[#17220F]">100%</div>
              <div className="text-xs font-bold text-[#46A304] uppercase tracking-wider mt-1">UPCL स्वीकृति</div>
              <div className="text-[11px] text-[#66705F]">नेट मीटरिंग प्रक्रिया</div>
            </div>
            <div className="text-center p-3 col-span-2 md:col-span-1">
              <div className="text-3xl sm:text-4xl font-heading font-extrabold text-[#17220F]">25+</div>
              <div className="text-xs font-bold text-[#46A304] uppercase tracking-wider mt-1">वर्ष वारंटी</div>
              <div className="text-[11px] text-[#66705F]">Tier-1 ALMM पैनल्स</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative">
              ...
              <div className="absolute top-6 -left-4 bg-[#17220F] text-white p-3.5 rounded-2xl shadow-xl border border-white/10 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-[#70C92F] uppercase font-bold mt-0.5">लीनियर परफॉर्मेंस वारंटी</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-5 lg:pl-6">
              ...
              <h2 className="text-2xl sm:text-4xl font-heading font-extrabold text-[#17220F] leading-tight">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-bold text-[#17220F]">MNRE और UPCL स्वीकृत पैनल्स</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <span className="w-5 h-5 rounded-full bg-[#46A304] text-white flex items-center justify-center flex-shrink-0">
                    <CheckIcon className="w-3.5 h-3.5" />
                  </span>
                  <span className="text-xs font-bold text-[#17220F]">₹85,800 तक केंद्रीय सब्सिडी</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <span className="w-5 h-5 rounded-full bg-[#46A304] text-white flex items-center justify-center flex-shrink-0">
                    <CheckIcon className="w-3.5 h-3.5" />
                  </span>
                  <span className="text-xs font-bold text-[#17220F]">3 वर्ष में लागत वसूली (ROI)</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <span className="w-5 h-5 rounded-full bg-[#46A304] text-white flex items-center justify-center flex-shrink-0">
                    <CheckIcon className="w-3.5 h-3.5" />
                  </span>
                  <span className="text-xs font-bold text-[#17220F]">24/7 स्थानीय इंजीनियर सहायता</span>
                </div>
              </div>
              ...
              <div className="pt-4">
                <Link
                  href="/about/"
                  className="group inline-flex items-center gap-2.5 px-6 py-3 rounded-full text-xs sm:text-sm font-extrabold text-[#17220F] bg-[#FFDE21] hover:bg-[#46A304] hover:text-white transition shadow-sm"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group rounded-2xl bg-white border border-[#E2E7DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="p-6">
                  <span className="text-[11px] font-bold text-[#46A304] uppercase tracking-wider">1 kW से 10 kW</span>
                  <h3 className="text-xl font-heading font-bold text-[#17220F] mt-1 mb-2">
                    आवासीय रूफटॉप सोलर
                  </h3>
            ...
            <div className="group rounded-2xl bg-white border border-[#E2E7DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="p-6">
                  <span className="text-[11px] font-bold text-[#46A304] uppercase tracking-wider">10 kW से 100 kW+</span>
                  <h3 className="text-xl font-heading font-bold text-[#17220F] mt-1 mb-2">
                    व्यावसायिक सोलर
                  </h3>
                  <p className="text-xs text-[#66705F] leading-relaxed mb-4">
            ...
            <div className="group rounded-2xl bg-white border border-[#E2E7DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="p-6">
                  <span className="text-[11px] font-bold text-[#46A304] uppercase tracking-wider">100 kW से मेगावाट</span>
                  <h3 className="text-xl font-heading font-bold text-[#17220F] mt-1 mb-2">
      ...
      <section className="bg-[#F7F9F5] py-16 sm:py-24 border-b border-[#E2E7DE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-[#E2E7DE] shadow-xs text-center flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-[#46A304] text-white flex items-center justify-center font-heading font-black text-xl mb-4 shadow-md">
                01
              </div>
              <h3 className="text-base font-heading font-bold text-[#17220F] mb-2">मुफ्त साइट सर्वे</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E2E7DE] shadow-xs text-center flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-[#17220F] text-[#46A304] flex items-center justify-center font-heading font-black text-xl mb-4 shadow-md border-2 border-[#46A304]">
                02
              </div>
              <h3 className="text-base font-heading font-bold text-[#17220F] mb-2">सब्सिडी व पोर्टल आवेदन</h3>
              <p className="text-xs text-[#66705F] leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E2E7DE] shadow-xs text-center flex flex-col items-center">
              ...
              <h3 className="text-base font-heading font-bold text-[#17220F] mb-2">1 दिन में इंस्टॉलेशन</h3>
              <p className="text-xs text-[#66705F] leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E2E7DE] shadow-xs text-center flex flex-col items-center">
              ...
              <h3 className="text-base font-heading font-bold text-[#17220F] mb-2">नेट मीटर व बैंक सब्सिडी</h3>
              <p className="text-xs text-[#66705F] leading-relaxed">
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    <h3 className="font-heading font-bold text-sm text-[#17220F] group-hover:text-[#46A304] transition">
                      {d.name}
                    </h3>
                    <MapPinIcon className="w-4 h-4 text-[#46A304]" />
                  </div>
                  <p className="text-[11px] text-[#66705F] mt-1 line-clamp-1">
                    {d.area}
                  </p>
                </div>
                <span className="text-[11px] font-bold text-[#46A304] mt-3 flex items-center gap-1">
      ...
      <section className="bg-[#17220F] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <Link
              href="/contact/?intent=quote"
              className="group inline-flex items-center gap-3 px-7 py-3.5 rounded-full text-sm font-extrabold text-[#17220F] bg-[#FFDE21] hover:bg-[#46A304] hover:text-white shadow-xl transition"
            >
