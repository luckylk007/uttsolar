      ...
      <section className="bg-[#17220F] text-white rounded-3xl p-8 sm:p-12 text-center space-y-5">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-xs sm:text-sm font-extrabold text-[#17220F] bg-[#FFDE21] hover:bg-[#46A304] hover:text-white transition shadow-md"
          >
