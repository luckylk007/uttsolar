      ...
      <section className="bg-[#F7F9F5] p-8 rounded-3xl border border-[#E2E7DE] text-center space-y-4">
        ...
        <div className="flex justify-center gap-3 pt-2">
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-xs font-extrabold text-[#17220F] bg-[#FFDE21] hover:bg-[#46A304] hover:text-white transition shadow-md"
          >
