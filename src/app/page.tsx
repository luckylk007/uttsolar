          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16 pb-20 sm:pt-20 sm:pb-28 lg:pt-24 lg:pb-32">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1A3321] border border-[#70BA3F]/40 text-[13px] font-semibold text-[#AEDB96]">
                ...
                <div className="bg-[#1A3321]/90 border border-white/10 rounded-2xl p-4 max-w-[620px] mx-auto lg:mx-0 shadow-lg">
                  <div className="grid grid-cols-3 divide-x divide-white/10 text-center">
                    ...
                    <div className="px-2">
                      <span className="text-[13px] font-semibold text-[#70BA3F] block">Recommended</span>
                      <span className="text-[17px] sm:text-[19px] font-bold text-[#70BA3F]">3 kW System</span>
                    </div>
                    <div className="px-2">
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                  <Link
                    ...
                    className="group inline-flex items-center gap-3 px-6 py-3.5 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#70BA3F] hover:bg-[#61A334] shadow-md hover:shadow-xl transition"
                  >
              ...
              <div className="lg:col-span-5">
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl border border-[#E1E8DE] text-[#172B1D]">
                  <div className="flex items-center justify-between mb-3">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[13px] font-semibold text-[#70BA3F] bg-[#F0F8EC]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 pt-4">
              <div className="text-center p-3">
                ...
                <div className="text-[13px] font-semibold text-[#70BA3F] mt-1.5">kW Capacity</div>
              ...
              <div className="text-center p-3">
                ...
                <div className="text-[13px] font-semibold text-[#70BA3F] mt-1.5">Happy Homes</div>
              ...
              <div className="text-center p-3">
                ...
                <div className="text-[13px] font-semibold text-[#70BA3F] mt-1.5">Commercial Plants</div>
              ...
              <div className="text-center p-3">
                ...
                <div className="text-[13px] font-semibold text-[#70BA3F] mt-1.5">UPCL Approval</div>
              ...
              <div className="text-center p-3 col-span-2 md:col-span-1">
                ...
                <div className="text-[13px] font-semibold text-[#70BA3F] mt-1.5">Years Warranty</div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 relative">
                ...
                <div className="absolute top-6 -left-4 bg-[#122417] text-white p-3.5 rounded-2xl shadow-xl border border-white/10 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[12px] text-[#AEDB96] font-semibold mt-1">Linear Warranty</div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 space-y-5 lg:pl-6">
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#E6F4DE] text-[13px] font-semibold text-[#467725]">
                ...
                <div className="pt-3">
                  <Link
                    href="/about/"
                    className="group inline-flex items-center gap-2.5 px-6 py-3 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#70BA3F] hover:bg-[#61A334] transition shadow-sm"
                  >
        ...
        <section className="bg-white py-16 sm:py-24 border-b border-[#E1E8DE]" id="services">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group rounded-2xl bg-white border border-[#E1E8DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="p-6">
                    <span className="text-[13px] font-semibold text-[#70BA3F] block">1 kW to 10 kW</span>
                ...
                <div className="px-6 pb-6 pt-2">
                  <Link
                    ...
                    className="inline-flex items-center justify-between w-full py-2.5 px-4 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#F4F7F2] group-hover:bg-[#70BA3F] group-hover:text-white transition"
                  >
              ...
              <div className="group rounded-2xl bg-white border border-[#E1E8DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="p-6">
                    <span className="text-[13px] font-semibold text-[#70BA3F] block">10 kW to 100 kW+</span>
                    <h3 className="text-[24px] lg:text-[28px] font-semibold text-[#122417] leading-[1.2] mt-1 mb-2">
                      Commercial Solar
                    </h3>
                    <p className="text-[14px] sm:text-[15px] text-[#687B6C] leading-[1.6] mb-4">
              ...
              <div className="group rounded-2xl bg-white border border-[#E1E8DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="p-6">
                    <span className="text-[13px] font-semibold text-[#70BA3F] block">100 kW to Megawatt</span>
                    <h3 className="text-[24px] lg:text-[28px] font-semibold text-[#122417] leading-[1.2] mt-1 mb-2">
                      Industrial Solar
                    </h3>
                    <p className="text-[14px] sm:text-[15px] text-[#687B6C] leading-[1.6] mb-4">
            ...
            <div className="text-center mt-10">
              <Link
                href="/services/"
                className="group inline-flex items-center gap-2 px-6 py-3 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#F4F7F2] hover:bg-[#E6F4DE] border border-[#E1E8DE] transition"
              >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#E1E8DE] shadow-xs text-center relative flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-[#70BA3F] text-white flex items-center justify-center font-bold text-[20px] mb-4 shadow-md">
                  01
                </div>
              ...
              {/* Step 2 */}
              <div className="bg-white p-6 rounded-2xl border border-[#E1E8DE] shadow-xs text-center relative flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-[#122417] text-[#70BA3F] flex items-center justify-center font-bold text-[20px] mb-4 shadow-md border-2 border-[#70BA3F]">
                  02
                </div>
            ...
            <div className="mt-12 text-center flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/contact/?intent=quote"
                className="group inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#70BA3F] hover:bg-[#61A334] shadow-md transition"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-[#1A3321] border border-white/10 mt-4">
                  ...
                  <div>
                    <span className="text-[12px] text-[#AEDB96] font-semibold block">Need Help Choosing?</span>
                    <a href={`tel:${siteConfig.phone}`} className="text-[16px] sm:text-[17px] font-bold text-white hover:text-[#70BA3F] transition">
        ...
        <section className="bg-[#F4F7F2] py-16 sm:py-24 border-b border-[#E1E8DE]" id="locations">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  <div>
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold text-[15px] text-[#122417] group-hover:text-[#70BA3F] transition">
                        {d.name}
                      </h3>
                  ...
                  <span className="text-[13px] font-semibold text-[#70BA3F] mt-3 flex items-center gap-1">
            ...
            <div className="text-center mt-10">
              <Link
                href="/locations/"
                className="group inline-flex items-center gap-2 px-6 py-3 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-white hover:bg-[#E6F4DE] border border-[#E1E8DE] transition shadow-xs"
              >
        ...
        <section className="bg-white py-16 sm:py-24 border-b border-[#E1E8DE]" id="projects">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-end justify-between gap-4 mb-12">
              ...
              <Link href="/projects/" className="text-[14px] font-semibold text-[#70BA3F] hover:underline flex items-center gap-1">
        ...
        <section className="bg-[#F4F7F2] py-16 sm:py-24 border-b border-[#E1E8DE]" id="blog">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
              ...
              <Link href="/blog/" className="text-[14px] font-semibold text-[#70BA3F] hover:underline flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              {recentBlogs.map((blog) => (
                <article key={blog.slug} className="bg-white rounded-2xl border border-[#E1E8DE] p-6 flex flex-col justify-between shadow-xs hover:shadow-lg transition">
                  <div>
                    <span className="text-[12px] font-semibold text-[#70BA3F] bg-[#F0F8EC] px-2.5 py-1 rounded-full">
                      {blog.category}
                    </span>
                  ...
                  <div className="pt-4 border-t border-[#E1E8DE] flex items-center justify-between text-[13px] text-[#687B6C]">
                    ...
                    <Link href={`/blog/${blog.slug}/`} className="font-semibold text-[#70BA3F] hover:underline flex items-center gap-1">
            ...
            <div className="max-w-[700px] mx-auto">
              ...
              <div className="space-y-3">
                {homeFaqs.map((faq, idx) => (
                  ...
                  >
                    <summary className="flex items-center justify-between cursor-pointer text-[15px] font-semibold text-[#122417] group-open:text-[#70BA3F] transition">
        ...
        <section className="bg-[#122417] text-white py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              <Link
                href="/contact/?intent=quote"
                className="group inline-flex items-center gap-3 px-7 py-3.5 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#70BA3F] hover:bg-[#61A334] shadow-xl transition"
              >
