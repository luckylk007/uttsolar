    ...
    <>
      ...
      <div className="flex flex-col bg-white text-[#172B1D]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16 pb-20 sm:pt-20 sm:pb-28 lg:pt-24 lg:pb-32">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1A3321] border border-[#2F8E04]/40 text-[13px] font-semibold text-[#71B402]">
                ...
                <h1 className="text-[36px] sm:text-[46px] lg:text-[56px] font-bold tracking-[-0.02em] text-white leading-[1.1]">
                  ...
                  With <span className="text-[#2F8E04]">Renewable Energy.</span>
                </h1>
                ...
                <div className="bg-[#1A3321]/90 border border-white/10 rounded-2xl p-4 max-w-[620px] mx-auto lg:mx-0 shadow-lg">
                  <div className="grid grid-cols-3 divide-x divide-white/10 text-center">
                    ...
                    <div className="px-2">
                      <span className="text-[13px] font-semibold text-[#2F8E04] block">Recommended</span>
                      <span className="text-[17px] sm:text-[19px] font-bold text-[#2F8E04]">3 kW System</span>
                    </div>
                    <div className="px-2">
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                  <Link
                    ...
                    className="group inline-flex items-center gap-3 px-6 py-3.5 rounded-full text-[15px] font-semibold leading-[1.2] text-white bg-[#2F8E04] hover:bg-[#012258] shadow-md hover:shadow-xl transition"
                  >
              ...
              <div className="lg:col-span-5">
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl border border-[#E1E8DE] text-[#172B1D]">
                  <div className="flex items-center justify-between mb-3">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[13px] font-semibold text-[#2F8E04] bg-[#F4F9EC]">
                      <LeafIcon className="w-3.5 h-3.5" />
                      Fast 30-Sec Booking
                    </span>
                    <span className="text-[13px] text-[#687B6C] font-medium">Free Survey</span>
                  </div>
                  <h3 className="text-[22px] sm:text-[26px] font-bold text-[#122417] leading-[1.2]">
                    Book Free Solar Survey
                  </h3>
                  <p className="text-[14px] text-[#687B6C] leading-[1.5] mt-1 mb-4">
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="bg-white border-b border-[#E1E8DE] py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-[700px] mx-auto mb-8">
              <h2 className="text-[24px] sm:text-[28px] lg:text-[32px] font-bold leading-[1.2] text-[#122417]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 pt-4">
              <div className="text-center p-3">
                <div className="text-[32px] sm:text-[40px] font-bold text-[#122417] leading-none">10K+</div>
                <div className="text-[13px] font-semibold text-[#2F8E04] mt-1.5">kW Capacity</div>
                <div className="text-[13px] text-[#687B6C]">Engineered &amp; Installed</div>
              </div>
              <div className="text-center p-3">
                <div className="text-[32px] sm:text-[40px] font-bold text-[#122417] leading-none">15K+</div>
                <div className="text-[13px] font-semibold text-[#2F8E04] mt-1.5">Happy Homes</div>
                <div className="text-[13px] text-[#687B6C]">Zero monthly power bills</div>
              </div>
              <div className="text-center p-3">
                <div className="text-[32px] sm:text-[40px] font-bold text-[#122417] leading-none">340+</div>
                <div className="text-[13px] font-semibold text-[#2F8E04] mt-1.5">Commercial Plants</div>
                <div className="text-[13px] text-[#687B6C]">Hotels, schools &amp; factories</div>
              </div>
              <div className="text-center p-3">
                <div className="text-[32px] sm:text-[40px] font-bold text-[#122417] leading-none">100%</div>
                <div className="text-[13px] font-semibold text-[#2F8E04] mt-1.5">UPCL Approval</div>
                <div className="text-[13px] text-[#687B6C]">Net metering liaison</div>
              </div>
              <div className="text-center p-3 col-span-2 md:col-span-1">
                <div className="text-[32px] sm:text-[40px] font-bold text-[#122417] leading-none">25+</div>
                <div className="text-[13px] font-semibold text-[#2F8E04] mt-1.5">Years Warranty</div>
                <div className="text-[13px] text-[#687B6C]">Tier-1 ALMM panels</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 relative">
                ...
                <div className="absolute top-6 -left-4 bg-[#122417] text-white p-3.5 rounded-2xl shadow-xl border border-white/10 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[12px] text-[#71B402] font-semibold mt-1">Linear Warranty</div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 space-y-5 lg:pl-6">
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#E5F4D3] text-[13px] font-semibold text-[#467725]">
                  <span className="w-2 h-2 rounded-full bg-[#2F8E04]" />
                  <span>About Green Energy Solar</span>
                </div>

                <h2 className="text-[30px] sm:text-[36px] lg:text-[42px] font-bold text-[#122417] leading-[1.15] tracking-[-0.015em]">
                  Transforming Uttarakhand Rooftops with Clean, Affordable Solar Power
                </h2>

                <p className="text-[16px] sm:text-[17px] text-[#687B6C] leading-[1.6] max-w-[650px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-[14px] font-medium text-[#172B1D]">MNRE &amp; UPCL Approved Panels</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#2F8E04] text-white flex items-center justify-center flex-shrink-0">
                      <CheckIcon className="w-3.5 h-3.5" />
                    </span>
                    <span className="text-[14px] font-medium text-[#172B1D]">Up to ₹85,800 Central Subsidy</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#2F8E04] text-white flex items-center justify-center flex-shrink-0">
                      <CheckIcon className="w-3.5 h-3.5" />
                    </span>
                    <span className="text-[14px] font-medium text-[#172B1D]">Fast 2.8-Year ROI Payback</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#2F8E04] text-white flex items-center justify-center flex-shrink-0">
                      <CheckIcon className="w-3.5 h-3.5" />
                    </span>
                    <span className="text-[14px] font-medium text-[#172B1D]">24/7 Local Engineer Support</span>
                  </div>
                </div>
                ...
                <div className="pt-3">
                  <Link
                    href="/about/"
                    className="group inline-flex items-center gap-2.5 px-6 py-3 rounded-full text-[15px] font-semibold leading-[1.2] text-white bg-[#2F8E04] hover:bg-[#012258] transition shadow-sm"
                  >
        ...
        <section className="bg-white py-16 sm:py-24 border-b border-[#E1E8DE]" id="services">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group rounded-2xl bg-white border border-[#E1E8DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="p-6">
                    <span className="text-[13px] font-semibold text-[#2F8E04] block">1 kW to 10 kW</span>
                    <h3 className="text-[24px] lg:text-[28px] font-semibold text-[#122417] leading-[1.2] mt-1 mb-2">
                      Residential Solar
                    </h3>
                    <p className="text-[14px] sm:text-[15px] text-[#687B6C] leading-[1.6] mb-4">
                    ...
                    <ul className="space-y-2 text-[14px] text-[#172B1D]">
                      <li className="flex items-center gap-2">
                        <CheckIcon className="w-3.5 h-3.5 text-[#2F8E04]" />
                ...
                <div className="px-6 pb-6 pt-2">
                  <Link
                    ...
                    className="inline-flex items-center justify-between w-full py-2.5 px-4 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#F4F7F2] group-hover:bg-[#2F8E04] group-hover:text-white transition"
                  >
              ...
              <div className="group rounded-2xl bg-white border border-[#E1E8DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="p-6">
                    <span className="text-[13px] font-semibold text-[#2F8E04] block">10 kW to 100 kW+</span>
                    <h3 className="text-[24px] lg:text-[28px] font-semibold text-[#122417] leading-[1.2] mt-1 mb-2">
                      Commercial Solar
                    </h3>
                    <p className="text-[14px] sm:text-[15px] text-[#687B6C] leading-[1.6] mb-4">
              ...
              <div className="group rounded-2xl bg-white border border-[#E1E8DE] overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="p-6">
                    <span className="text-[13px] font-semibold text-[#2F8E04] block">100 kW to Megawatt</span>
                    <h3 className="text-[24px] lg:text-[28px] font-semibold text-[#122417] leading-[1.2] mt-1 mb-2">
                      Industrial Solar
                    </h3>
                    <p className="text-[14px] sm:text-[15px] text-[#687B6C] leading-[1.6] mb-4">
            ...
            <div className="text-center mt-10">
              <Link
                href="/services/"
                className="group inline-flex items-center gap-2 px-6 py-3 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-[#F4F7F2] hover:bg-[#E5F4D3] border border-[#E1E8DE] transition"
              >
                <span>View All 17 Specialized Solar Services</span>
                <ArrowUpRightIcon className="w-3.5 h-3.5 text-[#2F8E04]" />
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#E1E8DE] shadow-xs text-center relative flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-[#2F8E04] text-white flex items-center justify-center font-bold text-[20px] mb-4 shadow-md">
                  01
                </div>
                <h3 className="text-[20px] lg:text-[22px] font-semibold text-[#122417] leading-[1.3] mb-2">Free Site Survey</h3>
                <p className="text-[14px] text-[#687B6C] leading-[1.6]">
              ...
              {/* Step 2 */}
              <div className="bg-white p-6 rounded-2xl border border-[#E1E8DE] shadow-xs text-center relative flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-[#122417] text-[#2F8E04] flex items-center justify-center font-bold text-[20px] mb-4 shadow-md border-2 border-[#2F8E04]">
                  02
                </div>
                <h3 className="text-[20px] lg:text-[22px] font-semibold text-[#122417] leading-[1.3] mb-2">Portal &amp; Subsidy Filing</h3>
                <p className="text-[14px] text-[#687B6C] leading-[1.6]">
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#E1E8DE] shadow-xs text-center relative flex flex-col items-center">
                ...
                <h3 className="text-[20px] lg:text-[22px] font-semibold text-[#122417] leading-[1.3] mb-2">1-Day Installation</h3>
                <p className="text-[14px] text-[#687B6C] leading-[1.6]">
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#E1E8DE] shadow-xs text-center relative flex flex-col items-center">
                ...
                <h3 className="text-[20px] lg:text-[22px] font-semibold text-[#122417] leading-[1.3] mb-2">Net Meter &amp; Subsidy</h3>
                <p className="text-[14px] text-[#687B6C] leading-[1.6]">
            ...
            <div className="mt-12 text-center flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/contact/?intent=quote"
                className="group inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full text-[15px] font-semibold leading-[1.2] text-white bg-[#2F8E04] hover:bg-[#012258] shadow-md transition"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-white border border-[#E1E8DE] transition"
              >
        ...
        <section className="bg-white py-16 sm:py-24 border-b border-[#E1E8DE]" id="calculator">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-[650px] mx-auto mb-12">
              ...
              <p className="text-[16px] sm:text-[17px] text-[#687B6C] leading-[1.6] mt-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10">
                ...
                <div className="absolute inset-0 bg-[#122417]/40 flex items-center justify-center">
                  <div className="w-16 h-16 rounded-full bg-[#2F8E04] text-white hover:bg-[#012258] flex items-center justify-center shadow-2xl hover:scale-110 transition cursor-pointer">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <div className="space-y-4 pt-2">
                  <div>
                    <div className="flex justify-between text-[14px] font-semibold mb-1.5">
                      ...
                      <span className="text-[#2F8E04]">98%</span>
                    </div>
                    <div className="w-full h-2.5 rounded-full bg-white/10 overflow-hidden">
                      <div className="h-full bg-[#2F8E04] rounded-full" style={{ width: '98%' }} />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between text-[14px] font-semibold mb-1.5">
                      ...
                      <span className="text-[#2F8E04]">100%</span>
                    </div>
                    <div className="w-full h-2.5 rounded-full bg-white/10 overflow-hidden">
                      <div className="h-full bg-[#2F8E04] rounded-full" style={{ width: '100%' }} />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between text-[14px] font-semibold mb-1.5">
                      ...
                      <span className="text-[#2F8E04]">99%</span>
                    </div>
                    <div className="w-full h-2.5 rounded-full bg-white/10 overflow-hidden">
                      <div className="h-full bg-[#2F8E04] rounded-full" style={{ width: '99%' }} />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-[#1A3321] border border-white/10 mt-4">
                  <div className="w-12 h-12 rounded-full bg-[#2F8E04] text-white hover:bg-[#012258] flex items-center justify-center flex-shrink-0">
                    <PhoneIcon className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="text-[12px] text-[#71B402] font-semibold block">Need Help Choosing?</span>
                    <a href={`tel:${siteConfig.phone}`} className="text-[16px] sm:text-[17px] font-bold text-white hover:text-[#2F8E04] transition">
        ...
        <section className="bg-[#F4F7F2] py-16 sm:py-24 border-b border-[#E1E8DE]" id="locations">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  <div>
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold text-[15px] text-[#122417] group-hover:text-[#2F8E04] transition">
                        {d.name}
                      </h3>
                      <MapPinIcon className="w-4 h-4 text-[#2F8E04]" />
                    </div>
                    <p className="text-[13px] text-[#687B6C] mt-1 line-clamp-1">
                      {d.majorServiceAreas.slice(0, 3).join(', ')}
                    </p>
                  </div>
                  <span className="text-[13px] font-semibold text-[#2F8E04] mt-3 flex items-center gap-1">
            ...
            <div className="text-center mt-10">
              <Link
                href="/locations/"
                className="group inline-flex items-center gap-2 px-6 py-3 rounded-full text-[15px] font-semibold leading-[1.2] text-[#122417] bg-white hover:bg-[#E5F4D3] border border-[#E1E8DE] transition shadow-xs"
              >
        ...
        <section className="bg-white py-16 sm:py-24 border-b border-[#E1E8DE]" id="projects">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-end justify-between gap-4 mb-12">
              ...
              <Link href="/projects/" className="text-[14px] font-semibold text-[#2F8E04] hover:underline flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {projects.slice(0, 3).map((project) => (
                <div key={project.slug} className="bg-white rounded-2xl border border-[#E1E8DE] p-6 flex flex-col justify-between shadow-xs hover:shadow-lg transition">
                  <div>
                    <div className="flex items-center justify-between text-[13px] font-semibold text-[#687B6C] mb-2">
                      <span className="text-[#2F8E04] bg-[#F4F9EC] px-2.5 py-0.5 rounded-full">{project.category}</span>
                      <span>{project.location}</span>
                    </div>
                    <h3 className="text-[20px] lg:text-[22px] font-semibold text-[#122417] leading-[1.3] mb-2">{project.title}</h3>
                    <p className="text-[14px] text-[#687B6C] leading-[1.6] line-clamp-3 mb-4">
                      {project.description}
                    </p>
                    <div className="grid grid-cols-2 gap-2 p-3 bg-[#F4F7F2] rounded-xl border border-[#E1E8DE] text-[13px] mb-4">
                      <div>
                        <span className="text-[#687B6C] block text-[12px]">Capacity:</span>
                        <strong className="text-[#122417]">{project.capacityKw} kW ({project.systemType})</strong>
                      </div>
                      <div>
                        <span className="text-[#687B6C] block text-[12px]">Annual Savings:</span>
                        <strong className="text-[#2F8E04]">{project.annualSavings}</strong>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="bg-[#F4F7F2] py-16 sm:py-24 border-b border-[#E1E8DE]" id="blog">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
              ...
              <Link href="/blog/" className="text-[14px] font-semibold text-[#2F8E04] hover:underline flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              {recentBlogs.map((blog) => (
                <article key={blog.slug} className="bg-white rounded-2xl border border-[#E1E8DE] p-6 flex flex-col justify-between shadow-xs hover:shadow-lg transition">
                  <div>
                    <span className="text-[12px] font-semibold text-[#2F8E04] bg-[#F4F9EC] px-2.5 py-1 rounded-full">
                      {blog.category}
                    </span>
                    <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#122417] mt-3 mb-2 leading-[1.3]">
                      <Link href={`/blog/${blog.slug}/`} className="hover:text-[#2F8E04] transition">
                        {blog.title}
                      </Link>
                    </h3>
                    <p className="text-[14px] text-[#687B6C] leading-[1.6] line-clamp-3 mb-4">
                  ...
                  <div className="pt-4 border-t border-[#E1E8DE] flex items-center justify-between text-[13px] text-[#687B6C]">
                    <span>{blog.readTime}</span>
                    <Link href={`/blog/${blog.slug}/`} className="font-semibold text-[#2F8E04] hover:underline flex items-center gap-1">
            ...
            <div className="max-w-[700px] mx-auto">
              <div className="text-center mb-8">
                <h3 className="text-[24px] sm:text-[28px] font-bold text-[#122417] leading-[1.2]">
              ...
              <div className="space-y-3">
                {homeFaqs.map((faq, idx) => (
                  ...
                  >
                    <summary className="flex items-center justify-between cursor-pointer text-[15px] font-semibold text-[#122417] group-open:text-[#2F8E04] transition">
                    ...
                    <p className="text-[14px] sm:text-[15px] text-[#687B6C] leading-[1.6] mt-3 pt-3 border-t border-[#E1E8DE]">
                      {faq.answer}
                    </p>
                  </details>
                ))}
        ...
        <section className="bg-[#122417] text-white py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              <Link
                href="/contact/?intent=quote"
                className="group inline-flex items-center gap-3 px-7 py-3.5 rounded-full text-[15px] font-semibold leading-[1.2] text-white bg-[#2F8E04] hover:bg-[#012258] shadow-xl transition"
              >
