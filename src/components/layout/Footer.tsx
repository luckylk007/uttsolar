...
export function Footer() {
  ...
  return (
    <footer className="bg-[#122417] text-slate-300 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 py-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <Link
                ...
                className="group inline-flex items-center gap-2 px-4 py-2 rounded-full text-[14px] font-semibold leading-[1.2] text-[#122417] bg-[#70BA3F] hover:bg-[#61A334] transition shadow-sm"
              >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-[14px] text-slate-300">
              ...
              <li>
                <Link href="/services/" className="text-[#70BA3F] font-semibold hover:underline">
                  All 17 Services →
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-[14px] text-slate-300">
              ...
              <li>
                <Link href="/locations/" className="text-[#70BA3F] font-semibold hover:underline">
      ...
      <div className="bg-[#70BA3F] text-[#122417] py-3.5 px-4 font-medium text-[13px] sm:text-[14px] text-center">
