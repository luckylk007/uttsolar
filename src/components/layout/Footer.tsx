...
export function Footer() {
  ...
  return (
    <footer className="bg-[#122417] text-slate-300 relative overflow-hidden">
      ...
      <div className="border-b border-white/10 py-6 sm:py-8 overflow-hidden select-none cursor-default bg-[#0C1A10]/60">
        <div className="animate-infinite-marquee marquee-bebas whitespace-nowrap text-4xl sm:text-6xl lg:text-[68px] font-normal tracking-wider uppercase items-center opacity-85 hover:opacity-100 transition-opacity">
          ...
          <div className="flex items-center gap-6 sm:gap-10 pr-6 sm:pr-10">
            <span className="text-[#2F8E04]">GENERATE YOUR OWN POWER</span>

            {/* Current / Lightning Bolt Sign */}
            <svg className="w-8 h-8 sm:w-11 sm:h-11 text-[#2F8E04] flex-shrink-0 animate-pulse" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
            ...
            <svg className="w-8 h-8 sm:w-11 sm:h-11 text-[#2F8E04] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pb-12 border-b border-white/10">
          <div className="flex items-center gap-4 p-5 rounded-2xl bg-[#1A3321] border border-white/10">
            <div className="w-12 h-12 rounded-full bg-[#2F8E04] text-white flex items-center justify-center flex-shrink-0">
              <PhoneIcon className="w-6 h-6" />
            </div>
            <div>
              <span className="text-[12px] text-[#71B402] font-medium block">
                Call Us Anytime
              </span>
              <div className="flex flex-col gap-0.5">
                <a
                  href={`tel:${siteConfig.phone}`}
                  className="text-[14px] sm:text-[15px] font-bold text-white hover:text-[#71B402] transition block"
                >
                  {siteConfig.phoneDisplay}
                </a>
                <a
                  href={`tel:${siteConfig.phoneSecondary}`}
                  className="text-[13px] sm:text-[14px] font-medium text-slate-300 hover:text-[#71B402] transition block"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 py-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              <div className="w-9 h-9 rounded-full bg-[#2F8E04] flex items-center justify-center text-white shadow-sm">
            ...
            <div className="flex items-center gap-3 pt-2">
              <Link
                ...
                className="group inline-flex items-center gap-2 px-4 py-2 rounded-full text-[14px] font-semibold leading-[1.2] text-white bg-[#2F8E04] hover:bg-[#012258] transition shadow-sm"
              >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-[14px] text-slate-300">
              <li>
                <Link href="/about/" className="hover:text-[#2F8E04] transition">
                  About UTTsolar
                </Link>
              </li>
              <li>
                <Link href="/pm-surya-ghar/" className="hover:text-[#2F8E04] transition">
                  PM Surya Ghar Scheme
                </Link>
              </li>
              <li>
                <Link href="/solar-subsidy/" className="hover:text-[#2F8E04] transition">
                  Uttarakhand Subsidy Rates
                </Link>
              </li>
              <li>
                <Link href="/calculator/" className="hover:text-[#2F8E04] transition">
                  Savings Calculator
                </Link>
              </li>
              <li>
                <Link href="/projects/" className="hover:text-[#2F8E04] transition">
                  Completed Projects
                </Link>
              </li>
              <li>
                <Link href="/blog/" className="hover:text-[#2F8E04] transition">
                  Solar Blog &amp; Insights
                </Link>
              </li>
              <li>
                <Link href="/contact/" className="hover:text-[#2F8E04] transition">
                  Contact Support
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-[14px] text-slate-300">
              {services.slice(0, 7).map((s) => (
                <li key={s.slug}>
                  <Link href={`/services/${s.slug}/`} className="hover:text-[#2F8E04] transition">
                    {s.title}
                  </Link>
                </li>
              ))}
              <li>
                <Link href="/services/" className="text-[#2F8E04] font-semibold hover:underline">
                  All 17 Services →
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-[14px] text-slate-300">
              {districts.slice(0, 7).map((d) => (
                <li key={d.slug}>
                  <Link href={`/locations/${d.slug}/`} className="hover:text-[#2F8E04] transition">
                    Solar in {d.name}
                  </Link>
                </li>
              ))}
              <li>
                <Link href="/locations/" className="text-[#2F8E04] font-semibold hover:underline">
      ...
      <div className="bg-[#2F8E04] text-white py-3.5 px-4 font-medium text-[13px] sm:text-[14px] text-center">
